/**
 * This is an example of the Composite design pattern. A composite pattern allows to split the code into a tree structure and treat each individual leaf uniformally.
